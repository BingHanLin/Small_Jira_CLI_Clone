...
impl JiraDatabase {
    ...
    pub fn create_epic(&self, epic: Epic) -> Result<u32> {
        ...
        db_state.epics.insert(next_id, epic);
        db_state.last_item_id = next_id;
    ...
    pub fn create_story(&self, story: Story, epic_id: u32) -> Result<u32> {
        ...
        let epic = db_state
            .epics
            .get_mut(&epic_id)
            .ok_or_else(|| Error::msg(format!("Epic with id {} not found", epic_id)))?;

        epic.stories.push(next_id);
        db_state.stories.insert(next_id, story);
        db_state.last_item_id = next_id;
    ...
    pub fn delete_story(&self, epic_id: u32, story_id: u32) -> Result<()> {
        ...
        let story_index = epic
            ...
            .ok_or_else(|| anyhow!("Could not find story in epic!"))?;
...
impl Database for JSONFileDatabase {
    ...
    fn write_db(&self, db_state: &DBState) -> Result<()> {
        let serialized = serde_json::to_string(db_state)
            .map_err(|e| anyhow!("Failed to serialize db_state: {}", e))?;

        return fs::write(&self.file_path, serialized)
